...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays,
        ...
        for(int i = 0; i < weatherArray.length(); i++) {
            ...
            weatherValues.put(WeatherEntries.COL_LOC_KEY, locationID);
            weatherValues.put(WeatherEntries.COLUMN_DATEtEXT,
                    WeatherContract.getDBdateString(new Date(dateTime * 1000L)));
            weatherValues.put(WeatherEntries.COLUMN_HUMIDITY, humidity);
            weatherValues.put(WeatherEntries.COLUMN_PRESSURE, pressure);
            weatherValues.put(WeatherEntries.COLUMN_WIND_SPEED, windSpeed);
            weatherValues.put(WeatherEntries.COLUMN_DEGREES, windDirection);
            weatherValues.put(WeatherEntries.COLUMN_MAX_TEMP, high);
            weatherValues.put(WeatherEntries.COLUMN_MIN_TEMP, low);
            weatherValues.put(WeatherEntries.COLUMN_SHORT_DESC, description);
            weatherValues.put(WeatherEntries.COLUMN_WEATHER_ID, weatherId);
            ...
            if (cVVector.size() > 0) {
                ...
                int rowsInserted = mContext.getContentResolver()
                        .bulkInsert(WeatherEntries.CONTENT_URI, cvArray);
